...
%\textbf{Evaluation}
%The max-pooling architectures were trained on a computing cluster using a distributed version of gradiend descent training called \textit{Downpour Stochastic Gradient Descent} \cite{dean_large_2012}.
...
The authors conclude: Pretraining models on just unrelated datasets (here 300 hours of YouTube videos) can increase action recognition performance.
